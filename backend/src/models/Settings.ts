...
const giftAccountSchema = new Schema(
  {
    ...
    wireRouting: { type: String, default: "" },
    achRouting: { type: String, default: "" },
  },
  { _id: false }
);
    ...
    giftAccounts: {
      ...
      default: () => [
        ...
        },
        {
          ...
          accountName: "Felix Adeolu Akintola",
          accountNumber: "214620542230",
          bankName: "Lead Bank",
          currency: "USD",
        ...
        {
          label: "USD / International",
          accountName: "Flora Oladipupo",
          accountNumber: "213899186176",
          bankName: "Lead Bank",
          currency: "USD",
          accountType: "Checking",
